...
class predictpipeline : 
    ...
    def predict(self,features):
        try:
            model_path=os.path.join("E:\\END_TO_END_Deployed\\mlproject\\artifacts\\model.pkl")
            preprocessor_path=os.path.join('E:\\END_TO_END_Deployed\\mlproject\\artifacts\\proprocessor.pkl')
